...
[![incentivized-💰](https://img.shields.io/badge/incentivized-💰-29220A.svg?style=for-the-badge)](https://praetoria.furya.xyz/)
![genesis-time](https://img.shields.io/badge/%E2%8F%B0%20genesis%20time-2022--12--14T15%3A00%3A00Z-red?style=for-the-badge)

## Register in the Genesis

> ℹ️ **Registration is only open for Druids 🧙‍♂️**. See [Praetoria program](https://praetoria.furya.xyz/).
...
```sh
# Init node
furyad --home mynode init your-moniker --chain-id praetoria-1

# Create keys, be careful with the mnemonic 👀
furyad --home mynode keys add your-key-name

# Set account necessary balance
furyad --home mynode add-genesis-account your-key-name 10000200000uknow
```
...
```sh
# Create the gentx
furyad --home mynode gentx your-key-name 10000000000uknow \
...
<table>
  ...
  <tr>
    ...
    <td>Haxxana furyad Validator</td>
    <td>
  ...
  <tr>
    ...
    <td>CryptoCrew validator &amp; multi-chain IBC-relayer service for Furya-TESTNET. Based in Europe. t.me/cryptocrew_validators</td>
    <td>
