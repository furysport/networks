...
```sh
# Init node
furyad --home mynode init your-moniker --chain-id furya-praetoria-1
...
<table>
  ...
  <tr>
    ...
    <td>P2P Validator (P2P.org) - an early Furya contributor &amp; long-time Cosmos Ecosystem participant. Stake with us for a secure, reliable and simple service</td>
    <td>
